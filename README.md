...
![BingeMate Banner](https://via.placeholder.com/1000x300?text=BingeMate+V1.1) 
...
🔗 **Live Demo:** [https://guru1316.github.io/BingeMate-V1.1/](https://guru1316.github.io/BingeMate-V1.1/)
...
1.  **Clone the repository**
    ```bash
    git clone [https://github.com/Guru1316/BingeMate-V1.1.git](https://github.com/Guru1316/BingeMate-V1.1.git)
    cd BingeMate-V1.1
    ```
...
_Made with ❤️ during my MERN Stack Internship._